...
KOBJS := assert.o main.o raise.o Install_Handler.o Restore_Handler.o exit.o read.o write.o S_Handler.o Load_User.o C_SWI_Handler.o sleep.o init_irq.o init_os_time.o irq_handler.o C_Irq_Handler.o test.o irq_stack_setup.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
