...
KOBJS := assert.o main.o raise.o Install_Handler.o Restore_Handler.o exit.o read.o write.o S_Handler.o Load_User.o C_SWI_Handler.o init_irq.o init_os_time.o Irq_Handler.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
